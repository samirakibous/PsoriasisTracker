...
public class AddMedicineActivity extends AppCompatActivity {
    ...
    private void openTimePickerDialog(boolean is24r) {
        ...
        timePickerDialog = new TimePickerDialog(
                ...
                is24r);
        timePickerDialog.setTitle("Régler le temps");
    ...
    private void ValidateProduct() {
        ...
        if (TextUtils.isEmpty(nameTxt)) {
            Toast.makeText(this, "Medication name is required", Toast.LENGTH_SHORT).show();
        }
        ...
        medRef.child(addData).updateChildren(medicMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    setReminder();
                    Intent intent = new Intent(AddMedicineActivity.this, TreatmentActivity.class);
                    ...
                    // loadingBar.dismiss();
                    Toast.makeText(AddMedicineActivity.this, "Order is added successfully..", Toast.LENGTH_SHORT).show();
                }else{
                    String message = task.getException().toString();
                    Toast.makeText(AddMedicineActivity.this, "Error: " + message, Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void setReminder() {
        // Récupérer les données de la médication
        String name = nameMed.getText().toString().trim();
        String dose = doseMed.getText().toString().trim();

        // Créer une intention pour l'AlarmReceiver
        ...
        Calendar calendar = Calendar.getInstance();
        // Exemple: Définir l'alarme pour 8 heures du matin
        calendar.set(Calendar.HOUR_OF_DAY, 8);
        calendar.set(Calendar.MINUTE, 0);
        calendar.set(Calendar.SECOND, 0);

        // Définir l'alarme avec l'AlarmManager
